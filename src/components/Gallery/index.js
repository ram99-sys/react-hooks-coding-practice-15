...
const Gallery = () => {
  const [activeId, setActiveId] = useState(imagesList[0].id)

  const displayActiveThumbNail = id => {
    // console.log(id)
    setActiveId(id)
  }
  ...
  const activeImage = getFilteredGalleryItems()
      ...
      <ul className="photos-list">
        {imagesList.map(eachImage => (
          <ThumbnailItem
            ...
            displayActiveThumbNail={displayActiveThumbNail}
